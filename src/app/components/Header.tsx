...
export default function Header () {
    return (
        <div className={`${style.headerContainer} w-screen bg-white/60 flex justify-between items-center content-center z-10 fixed`}>
            <div className="flex min-w-[100vw] justify-between items-center text-sm pl-10">
                ...
                <div className={`flex justify-center content-center items-center p-3 rounded-l-full ${style.avatarContainer}`}>
                    ...
                    <div className="title">
                        <p className='font-black'> trizky2022 </p>
                        <small className='font-medium'> 0x92831....124b </small>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
